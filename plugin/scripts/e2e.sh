...
SCENARIOS=(
  "simple|Reply with just the word ok.|main loop · verdict via api: fast@;main loop · model \("
  "subagent|Use the Agent tool with subagent_type general-purpose to answer: what is 2+2? Do not answer it yourself.|subagent general-purpose · verdict via api: fast@;subagent general-purpose · model \(.* → haiku"
